  ...
  return (
    <Reveal>
      <section className="mx-auto max-w-7xl px-4 pt-16 sm:px-6 sm:pt-20 lg:px-10 lg:pt-28">
        ...
        <h2 className="mb-10 max-w-3xl type-h2 tracking-[-0.012em] sm:mb-14">
          {t(c.problem.title)}
          <br />
        ...
        <div className="flex flex-col border-t border-white/8">
          {c.problem.items.map((item, i) => (
            ...
            >
              <span className="min-w-10 type-h3 text-[rgba(184,115,51,.55)] sm:min-w-13">
                {String(i + 1).padStart(2, "0")}
              </span>
              <p className="type-lead max-w-3xl leading-snug text-[#dcd8d1]">
                {t(item)}
              </p>
            </div>
          ))}
